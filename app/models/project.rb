...
class Project < ApplicationRecord
  ...
  has_many :developers, class_name: 'User', through: :project_developers, dependent: :destroy, source: :user
  has_many :project_qas, dependent: :destroy
  has_many :qas, class_name: 'User', through: :project_qas, dependent: :destroy, source: :user
  has_one  :project_manager, dependent: :destroy
  has_one :manager, class_name: 'User', through: :project_manager, dependent: :destroy, source: :user
